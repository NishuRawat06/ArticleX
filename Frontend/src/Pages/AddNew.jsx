...
import Fetch, { postFetch } from "../utils/request";
...
export default function AddNew() {
  ...
  const islogedin = useAtomValue(isLoggedIn);
  useEffect(() => {
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              className="bg-transparent border border-[#8B8578]/25 rounded-md text-[#FBF8F2] px-3 py-3 min-h-55 focus:outline-none focus:border-[#C9A227] focus:shadow-[0_0_0_3px_rgba(201,162,39,0.12)] transition-all resize-none placeholder:text-[#6E6C64]"
